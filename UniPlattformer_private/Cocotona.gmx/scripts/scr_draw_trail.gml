///scr_draw_trail(length,width,color,sprite,slim,alpha)

/*You must use the draw_trail script on one of the Draw events in the object you wish to draw the trail
from.*/
